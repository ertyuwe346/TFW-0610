...
[![Deploy](https://www.herokucdn.com/deploy/button.png)](https://dashboard.heroku.com/new?template=https://github.com/ertyuwe346/TFW-0610) 
...
|端口|443|
|默认UUID|731cfc84-b153-4013-83d3-5aa49d85bc69</br>**注意：务必创建时自定义UUID码**|
...
|服务器地址|自选ip（如：`uicdn.cf`或`icook.tw`）</br>应用程序名.herokuapp.com|
|端口|443|
|密码|731cfc84-b153-4013-83d3-5aa49d85bc69</br>**注意：务必创建时自定义UUID码**|
|传输协议|ws|
